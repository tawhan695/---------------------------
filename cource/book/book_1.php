    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div id="section1" class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <br>
                    <br>
                    <h4>สถานะ : <span class="label label-success">อยู่ในภาควิชาฯ</span></h4>
                    <div class="row">
                      
                        <div class="col-sm-6 col-lg-6 col-md-6">
                            <button type="button" id="ju" class=" button1 btn btn-success btn-lg btn-toolbar" data-toggle="modal" data-target="#myModal">แจ้งยืม</button>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class=" modal-body text-center">
                                            <h3>ยืนยันการแจ้งยืม</h3>
                                            <p>*เล่มปริญญานิพนธ์</p>
                                            <div class="row">
                                                <div class="col-sm-6"> <a ><button type="button" class="btn-model1 btn btn-info btn-block" onclick="show2()" data-dismiss="modal">ตกลง</button></a></div>
            ...
            <div class="tableJ"  id="show1">
                <div> 
                    ...
                    <h4>
                       แจ้งยืมเล่มปริญญษนิพนธ์โดย :<span class="badge">ทนงศักดิ์ บุญมา รหัสนิสิต 5940201997</span><span class="badge">รออนุมัติ</span>
                    </h4>
                </div>
                <br>
                <br>
        ...
        <script>
            ...
            function show2(){
                 ...
                 document.getElementById('ju').innerHTML ="ยกเลิก แจ้งยืม";
                 document.getElementById('ju').style ="background-color: rad;";
